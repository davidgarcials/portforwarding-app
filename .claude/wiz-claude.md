...
## Branch naming
must contain a valid Jira prefix + 1-8 digits. Valid prefixes: `ACME-`, `LAN-`, `ESAP-`, `FING-`, `CDKC-`, `PLAT-`, `ENSE-`, `POC-`. Preferred defaults: `ACME-XXXXX/desc` (Jira stories), `POC-XXXXX/desc` (internal plans). Override per-repo in CLAUDE.md if your team uses a different prefix.   
